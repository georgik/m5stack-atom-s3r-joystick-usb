 ...
 * @param button_a Joystick click (left stick button). Restart the game when game
 *                 over; return to the profile menu while playing. A rising edge is
 *                 detected, so a held button triggers exactly once.
 * @param button_b I2C LEFT face button. Returns to the profile menu.
